...
public function __construct($tit_projeto, $dti_projeto, $res_projeto, $dtt_projeto)
{
...
public function CadastroPub(){
    ...
    return $this->setCadastroPub($tit_projeto, $dti_projeto, $res_projeto, $dtt_projeto);
}
}
?>